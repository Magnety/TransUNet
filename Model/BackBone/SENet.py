...
class SEBottleneck(Bottleneck):
    ...
    def __init__(self, inplanes, planes, groups, reduction, stride=1,
        ...
        self.conv2 = nn.Conv3d(planes * 2, planes * 4, kernel_size=3,
                               stride=stride, padding=1, groups=groups,
                               bias=False)
        self.bn2 = nn.BatchNorm3d(planes * 4)
        self.conv3 = nn.Conv3d(planes * 4, planes * 4, kernel_size=1,
                               bias=False)
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
                 inplanes=128, downsample_kernel_size=3, input_3x3=True,
        ...
        if input_3x3:
            layer0_modules = [
                ('conv1', nn.Conv3d(1, 64, [1, 3, 3], stride=2, padding=1,
                                    bias=False)),
            ...
            layer0_modules = [
                ('conv1', nn.Conv3d(1, inplanes, kernel_size=[7, 7, 7], stride=2,
                                    padding=3, bias=False)),
                ('bn1', nn.BatchNorm3d(inplanes)),
                ('relu1', nn.ReLU(inplace=True)),
            ]

        layer0_modules.append(('pool', nn.MaxPool3d(3, stride=2,
                                                    ceil_mode=True)))
        ...
        self.last_linear = nn.Linear(1024 * block.expansion, num_classes)

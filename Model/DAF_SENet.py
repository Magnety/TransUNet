...
class DAF_SENet(nn.Module):
    def __init__(self):
        super(DAF_SENet,self).__init__()
        self.backbone = BackBone3D()
        self.down4 = nn.Sequential(
            nn.Conv3d(4096, 128, kernel_size=1),
            nn.GroupNorm(32, 128),
            nn.PReLU(),
        )
        ...
        self.fc1 = nn.Linear(7684, 2048)
        self.fc2 = nn.Linear(2048, 512)

        self.fc3 = nn.Sequential(nn.Linear(512, 2), nn.LogSoftmax())
    ...
    def forward(self, x):
        ...
        feature1 = self.extra_feature1(layer1)
        feature2 = self.extra_feature1(layer2)
        feature3 = self.extra_feature1(layer3)
        feature4 = self.extra_feature1(layer4)
        ...
        print(predict1_1.shape)
        feature5 = self.extra_feature1(predict1_4)
        feature6 = self.extra_feature2(predict1_3)
        feature7 = self.extra_feature3(predict1_2)
        feature8 = self.extra_feature4(predict1_1)
        feature = torch.cat((feature1, feature2, feature3, feature4,feature5,feature6,feature7,feature8), 1)
        ...
        return predict1_1, predict1_2, predict1_3, predict1_4, \
               predict2_1, predict2_2, predict2_3, predict2_4, predict, cls_out
